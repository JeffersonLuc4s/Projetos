...
// Produtos "virais" — alta popularidade no nicho
const VIRAL_PRODUCTS = [
  "gojo", "naruto", "luffy", "goku", "tanjiro", "nezuko",
  "itachi", "zoro", "demon slayer", "attack on titan",
  "jujutsu", "chainsaw man", "spy x family"
];
