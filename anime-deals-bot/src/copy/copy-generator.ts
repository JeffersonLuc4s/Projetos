 ...
 *
 * Gera textos no estilo otaku com urgência, escassez e prova social.
...
Sua função é gerar copy de alta conversão para produtos de anime (figures, funko pops, mangás) no Telegram.
...
const SOCIAL_PROOF_PHRASES = [
  "Muito bem avaliado pelos fãs!",
  "Aprovado pelos otakus! ✅",
  "Um dos mais elogiados da categoria!",
  "Fãs amaram! Veja as avaliações.",
];
