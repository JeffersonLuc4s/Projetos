...
export const BOOK_AUTHOR_KEYWORDS = [
  ...
  "Afonso Arinos", "Afonso Celso", "Agatha Christie", "Aiden Thomas", "Akemi Dawn Bowman",
  "Aleksandr Afanasev", "Alex Michaelides", "Alexandra Bracken", "Alexandra Christo",
  "Alexandre Callari", "Alexandre Dumas", "Alexene Farol Follmuth", "Alexis Henderson",
  "Ali Hazelwood", "Alice Oseman", "Allison Saft", "Aluisio de Azevedo", "Álvares de Azevedo",
  "Alwyn Hamilton", "Amber Hamilton", "Amélie Wen Zhao", "Amie Kaufman", "Ana Huang",
  "André Pereira", "Andrew Pyper", "Andy Weir", "Ann C. Wolbert Burgess", "Ann Liang",
  "Ann Rule", "Anne Frank", "Anne Rice", "Antoine de Saint-Exupéry", "Antonio Tibau",
  "Arin Murphy-Hiscock", "Aristófanes", "Arnold Van de Laar", "Ashley Poston",
  "Autumn Woods", "Ava Reid", "Ayana Grey", "Akemi Dawn Dawn Bowman", "Bal Khabra", "Barbara Yelin",
  "Barry E. Zimmerman", "Becca Fitzpatrick", "Becky Chambers", "Benjamin Alire Sáenz",
  "Bernardo Guimarães", "Beth O'Leary", "Bev Vincent", "Blake Crouch", "Bram Stoker",
  "Brandon Sanderson", "Bret Easton Ellis", "Brian James Freeman", "Brian Keene",
  ...
  "Cathryn Kemp", "Cesar Bravo", "Charles Addams", "Charles Dickens", "Charles Perrault",
  "Charlie Donlea", "Charlotte Gordon", "Chloe Gong", "Chloe Walsh", "Christelle Dabos",
  "Cinda Williams Chima", "Clarice Lispector", "Cláudia Lemes", "Clive Barker",
  "Coelho Neto", "Colin Meloy", "Colleen Hoover", "Constance Sayers", "Cornelia Funke",
  "Cressida Cowell", "Damion Searls", "Dani Francis", "Daniel Defoe", "Daniela Arbex",
  "Danielle L. Jensen", "Danya Kukafka", "Demi Winters", "Devney Perry", "Diana Gabaldon",
  "Diana Wynne Jones", "Donna Barba Higuera", "Dr. Vincent Di Maio", "E. J. Mellow",
  "E. Lockhart", "Edgar Allan Poe", "Eleanor H. Porter", "Elena Armas", "Elise Kova",
  "Elizabeth Helen", "Elizabeth Lim", "Elle Kennedy", "Elsie Silver", "Emily Brontë",
  "Emily Henry", "Emily Thiede", "Emily Varga", "Emily Winfield Martin", "Emma Lord",
  "Eric Weiner", "Erika Johansen", "Erin A. Craig", "Erin Beaty", "Erin Morgenstern",
  "Ernest Cline", "Eurípides", "Everaldo Rodrigues", "F. Scott Fitzgerald", "F.T. Lukens",
  "Fagundes Varela", "Faridah Àbíké-Íyímídé", "Fernando Toste", "Ferréz",
  "Fiódor Dostoiévski", "Fonda Lee", "Frances Hardinge", "Frances Hodgson Burnett",
  "Frank Herbert", "Franz Kafka", "Freida McFadden", "Freya Marske", "Gareth Hanrahan",
  "Gary Brucato", "Gary Kinder", "Gary Whitta", "Gaston Leroux", "Genevieve Cogman",
  "Genevieve Gornichec", "George Orwell", "George R. R. Martin", "Gerald Brittle",
  "Gillian Flynn", "Graciliano Ramos", "Gregg Olsen", "Hafsah Faizal", "Hannah Bonam-Young",
  ...
  "Harper Lee", "Holly Black", "Holly Jackson", "Howard Pyle", "Humberto de Campos",
  "I. V. Marie", "Ilana Casoy", "Imani Erriu", "Inglês de Sousa", "Irmãos Grimm",
  "J.K. Rowling", "J. M. Barrie", "J. R. R. Tolkien", "J.R.R. Tolkien", "Jack Ketchum", "Jack London",
  "Jacob Grimm", "James Kahn", "Jane Austen", "Jay Anson", "Jay Kristoff", "Jaysea Lynn",
  "Jeff Guinn", "Jeanne Marie Leprince de Beaumont", "Jenna Evans Welch", "Jenna Levine",
  "Jennifer L. Armentrout", "Jennifer Lynn Barnes", "Jennifer Niven", "Jennifer Wright",
  "Jenny Han", "Jo Nesbø", "Joanne Harris", "João do Rio", "Joe Navarro", "Joël Dicker",
  "John Ajvide Lindqvist", "John Boyne", "John Gwynne", "John Michael Greer", "John Scalzi",
  "Jojo Moyes", "Jordan Stephanie Gray", "José de Alencar", "Josiah Bancroft",
  "Judy I. Lin", "Julia Johnson", "Julia Lopes de Almeida", "Julia Quinn", "Julie Berry",
  ...
  "Kerri Maniscalco", "Kevin Quigley", "Kiera Azar", "Kiera Cass", "Kiersten White",
  "Kristen Ciccarelli", "Kristy Boyce", "Kritika H. Rao", "L. Frank Baum", "L. K. Steven",
  "Laini Taylor", "Lana Ferguson", "Laura Purcell", "Laura Sebastian", "Lauren Asher",
  "Lauren Kate", "Lauren Roberts", "Leia Stone", "Leigh Bardugo", "Leslie Wolfe",
  "Leticia Wierzchowski", "Lewis Carroll", "Linda Bailey", "Lisa Gardner", "Lisa Kleypas",
  "Lisa Maxwell", "Liza Palmer", "Luciano Lamberti", "Lucy Foley", "Lydia Kang",
  "Lyla Sage", "Lynette Noni", "Lynn Painter", "Lyssa Kay Adams", "M. L. Rio",
  "M. L. Wang", "Machado de Assis", "Mackenzi Lee", "Madeleine L'Engle", "Maggie Stiefvater",
  "Marco de Castro", "Margaret Atwood", "Margaret Owen", "Margaret Rogerson",
  "Mariana Zapata", "Marie Lu", "Marissa Meyer", "Mark Lawrence", "Mark Twain",
  "Markus Zusak", "Martin Connolly", "Marv Wolfman", "Mary Lynn Bracht", "Mary Shelley",
  "Mary Turner Thomson", "Matt Haig", "Maureen Callahan", "Maureen Johnson", "Maureen Orth",
  "Maurene Goo", "Medeiros e Albuquerque", "Meg Cabot", "Melissa Albert",
  "Melissa Bashardoust", "Melissa Grey", "Mendal W. Johnson", "Michael H. Stone",
  ...
  "Olivia Rose Darling", "Olivie Blake", "P. D. Cacek", "P. L. Travers", "Pascale Lacelle",
  ...
  "Rainbow Rowell", "Ramsey Campbell", "Raphael Montes", "Raven Kennedy", "Ray Bradbury",
  ...
  "Roald Dahl", "Robert Bloch", "Robert Bryndza", "Robert Curran", "Robert Jackson Bennett",
  "Robert Jordan", "Robert K. Ressler", "Robert L. Stevenson", "Robert Louis Stevenson", "Ronald Hutton",
  "Rory Power", "Roshani Chokshi", "Rudyard Kipling", "S. A. Chakraborty",
  "S. F. Williamson", "Saara El-Arifi", "Sabaa Tahir", "Sable Sorensen", "Samantha Shannon",
  "Sara Holland", "Sarah A. Parker", "Sarah Adams", "Sarah J. Maas", "Sarah Penner",
  "Sarah Tolcser", "Sasha Peyton Smith", "SenLinYu", "Shannon Mayer", "Shelby Mahurin",
  "Socorro Acioli", "Soman Chainani", "Sophie Anderson", "Sophie Kim", "Soraya Abuchaim",
  "Stacia Stark", "Stephanie Archer", "Stephanie Garber", "Stephen King", "Stephenie Meyer",
  "Steven Matthew Constantine", "Stewart O'Nan", "Sue Lynn Tan", "Susan Dennard",
  "Suzanne Collins", "Svetlana Aleksiévitch", "T. J. Klune", "Tabitha Suzuma",
  "Tahereh Mafi", "Taisia Kitaiskaia", "Talia Hibbert", "Tasha Suri", "Taylor Jenkins Reid",
  "Teri Terry", "Tessa Dare", "Thea Guanzon", "Thomas Morris", "Tolstói", "Tom Shachtman",
  "Tomi Adeyemi", "Toni Cade Bambara", "Toni Maguire", "Tracy Banghart", "Tracy Deonn",
  "Tricia Levenseller", "Truman Capote", "Valêncio Xavier", "Veronica Roth", "Victor Hugo",
  "Victoria Aveyard", "Victoria Schwab", "V. E. Schwab", "Virginia Woolf", "Vitor Abdala",
